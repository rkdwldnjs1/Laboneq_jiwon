...
"""This module defines the amplitude-CR experiment. (modified from amplitude-rabi.py at SQNL: 2024)

In this experiment, we sweep the amplitude of a drive pulse on a control qubit with a target qubit transition frequency
...
@workflow.workflow(name="amplitude_CR")
